...
#define EP0_BUFF_SIZE           32  // 8, 16, 32, or 64
...
#define HID_INPUT_REPORT_BYTES   10
#define HID_OUTPUT_REPORT_BYTES  32
#define HID_FEATURE_REPORT_BYTES 32
